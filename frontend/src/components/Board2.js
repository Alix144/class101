...
const Board = ({name, courseCode, invitationCode, description, maxStudents, classColor, instructors, students}) => {
    ...
    return ( 
        <div className="board2">
            <ClassInfo name={name} courseCode={courseCode} invitationCode={invitationCode} description={description} maxStudents={maxStudents} classColor={classColor} instructors={instructors} students={students}/>
            <div className="nav">
